...
export default function LeaderboardRow({
  ...
  const getRankClass = (idx: number) => {
    if (idx === 0)
      return "bg-yellow-50/70 dark:bg-yellow-950/20 border-yellow-200 dark:border-yellow-900/50 hover:bg-yellow-100/50 dark:hover:bg-yellow-950/30";
    if (idx === 1)
      return "bg-gray-50/70 dark:bg-slate-900/40 border-gray-200 dark:border-slate-800 hover:bg-gray-100/50 dark:hover:bg-slate-800/60";
    if (idx === 2)
      return "bg-amber-50/70 dark:bg-amber-950/20 border-orange-200 dark:border-orange-900/40 hover:bg-amber-100/50 dark:hover:bg-amber-950/30";
