    ...
    <form action={dispatch} className="space-y-4">
      <div>
        ...
        <input
          ...
          id="code"
          required
          className="mt-1 block w-full rounded-md text-gray-800 border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm p-2 border uppercase"
